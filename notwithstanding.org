...
(straight-use-package '(pulsar :type git :repo "https://gitlab.com/protesilaos/pulsar"))
...
(setq company-global-modes '(not message-mode telega-chat-mode circe-channel-mode))
...
(setq modus-themes-mode-line '(borderless accented 5))
