...
(setq j0ni/fixed-font "Recursive Mono Linear Static-9.0")
(setq j0ni/fixed-font-serif "Recursive Mono Casual Static-9.0")
;; (setq j0ni/fixed-font (font-spec :family "Lucida Grande Mono" :size 11.0 :antialias t))
(setq j0ni/variable-font "Recursive Sans Casual Static-9.0")
